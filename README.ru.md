...
**Исправления:**
* **Исправление Video Caption**: Исправлена проблема, при которой некоторые модели (например, Qwen3.5-Plus) ошибочно определялись как не поддерживающие многокадровый анализ. Добавлено интеллектуальное определение лимита кадров и автоматическая обрезка для предотвращения прерывания задач.
* **Оптимизация регистрации в подграфах**: Исправлена инициализация и стабильность ассистента в узла подграфов (Subgraph) в режимах Node 2.0 (Vue) и LiteGraph. Добавлено точное соответствие для нескольких полей ввода с одинаковыми именами.
